...
import { useForwardPropsEmits, SelectRoot, useForwardProps, SelectItem, SelectItemIndicator, SelectItemText, SelectScrollDownButton, SelectScrollUpButton, SelectTrigger, SelectIcon, SelectValue, SelectPortal, SelectContent, SelectViewport } from 'radix-vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(SelectItem), mergeProps(unref(forwardedProps), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="absolute right-2 h-3.5 w-3.5 flex items-center justify-center"${_scopeId}>`);
            ...
            return [
              createVNode("span", { class: "absolute right-2 h-3.5 w-3.5 flex items-center justify-center" }, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "default", {}, () => {
              _push2(ssrRenderComponent(_component_Icon, { name: "i-radix-icons-chevron-down" }, null, _parent2, _scopeId));
            }, _push2, _parent2, _scopeId);
          } else {
            return [
              renderSlot(_ctx.$slots, "default", {}, () => [
                createVNode(_component_Icon, { name: "i-radix-icons-chevron-down" })
              ])
            ];
          }
        }),
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(SelectScrollUpButton), mergeProps(unref(forwardedProps), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "default", {}, () => {
              _push2(ssrRenderComponent(_component_Icon, { name: "i-radix-icons-chevron-up" }, null, _parent2, _scopeId));
            }, _push2, _parent2, _scopeId);
          } else {
            return [
              renderSlot(_ctx.$slots, "default", {}, () => [
                createVNode(_component_Icon, { name: "i-radix-icons-chevron-up" })
              ])
            ];
          }
        }),
...
export { _sfc_main$6 as _, _sfc_main$2 as a, _sfc_main$1 as b, _sfc_main as c, _sfc_main$5 as d };
//# sourceMappingURL=SelectContent.vue2.mjs.map
