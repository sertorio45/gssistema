...
import { a as _sfc_main$1, d as cn } from './server.mjs';
...
import { _ as _sfc_main$6 } from './Slider.vue2.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Slider = _sfc_main$6;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-4" }, _attrs))}><div class="grid gap-2"><div><h2 class="text-2xl font-bold tracking-tight"> Slider </h2><p class="text-muted-foreground"> An input where the user selects a value from within a given range. </p></div><div class="flex gap-2">`);
            ...
            _push2(ssrRenderComponent(_component_CardContent, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Slider, {
                    modelValue: unref(modelValue),
                    "onUpdate:modelValue": ($event) => isRef(modelValue) ? modelValue.value = $event : null,
                    max: 100,
                    step: 1,
                    class: ("cn" in _ctx ? _ctx.cn : unref(cn))("w-3/5", _ctx.$attrs.class ?? "")
...
//# sourceMappingURL=slider.vue.mjs.map
