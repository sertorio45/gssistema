...
import { _ as _sfc_main$6 } from './TooltipProvider.vue2.mjs';
import { _ as _sfc_main$7, a as _sfc_main$8, b as _sfc_main$9 } from './TooltipTrigger.vue2.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_TooltipProvider = _sfc_main$6;
  const _component_Tooltip = _sfc_main$7;
  const _component_TooltipTrigger = _sfc_main$8;
  const _component_TooltipContent = _sfc_main$9;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-4" }, _attrs))}><div class="grid gap-2"><div><h2 class="text-2xl font-bold tracking-tight"> Tooltip </h2><p class="text-muted-foreground"> A popup that displays information related to an element when the element receives keyboard focus or the mouse hovers over it. </p></div><div class="flex gap-2">`);
                        ...
                        if (_push5) {
                          _push5(ssrRenderComponent(_component_TooltipTrigger, { "as-child": "" }, {
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(ssrRenderComponent(_component_Button, { variant: "outline" }, {
                          ...
                          _push5(ssrRenderComponent(_component_TooltipContent, null, {
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<p${_scopeId5}>Add to library</p>`);
                              } else {
                                return [
