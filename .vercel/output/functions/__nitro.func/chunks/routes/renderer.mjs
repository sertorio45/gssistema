...
import { e as buildAssetsURL, u as useRuntimeConfig, f as getResponseStatusText, h as getResponseStatus, j as defineRenderHandler, k as publicAssetsURL, l as getQuery, c as createError, m as getRouteRules, n as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Nuxt App"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Nuxt App"};
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.a3; }).then((r) => r.default || r);
